...
void main() {
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      // Mock data response
      when(() => mockProductService.fetchData('Nike', 100, 500, OrderType.asc, 10, 1, pagingController)).thenAnswer(
        (_) => [
          SPGroupedHits(
            hits: [
              SPHits(
      ...
      pagingController.appendPage(await mockProductService.fetchData('Nike', 100, 500, OrderType.asc, 10, 1, pagingController), 2);
      await tester.pump();
  ...
  testWidgets(
    'Loads more items when scrolled',
    (WidgetTester tester) async {
      final pagingController = PagingController<int, SPGroupedHits>(firstPageKey: 1);
      final mockProductService = MockProductService();
      ...
      when(() => mockProductService.fetchData('Nike', 100, 500, OrderType.asc, 10, 2, pagingController)).thenAnswer(
        (_) => [
          SPGroupedHits(
            hits: [
              SPHits(
...
Future<Widget> spHomePage(
    PagingController<int, SPGroupedHits> pagingController) async {
  return MaterialApp(
    home: Scaffold(
